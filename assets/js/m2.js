function updateNav() {
  ...
  $vlinks.width() > e
      ...
      $btn.attr("count", breaks.length), $vlinks.width() > e && updateNav()
}
!function(e, t) {
  ...
  function(e, t) {
    ...
    function i(e, t, n) {
      if (pe.isFunction(t))
        return pe.grep(e, function(e, i) { return !!t.call(e, i, e) !== n });
      if (t.nodeType)
    ...
    function o(e) {
      var t = {};
      return pe.each(e.match(Ae) || [], function(e, n) { t[n] = !0 }), t
    }
    function a() {
      ie.addEventListener ? (ie.removeEventListener("DOMContentLoaded", s),
                             e.removeEventListener("load", s))
                          : (ie.detachEvent("onreadystatechange", s),
                             e.detachEvent("onload", s))
    }
    function s() {
      (ie.addEventListener || "load" === e.event.type ||
    ...
    function c(e, t, n, i) {
      if (Ie(e)) {
        var r, o, a = pe.expando, s = e.nodeType, l = s ? pe.cache : e,
                  u = s ? e[a] : e[a] && a;
        if (u && l[u] && (i || l[u].data) || void 0 !== n ||
            "string" != typeof t)
          return u || (u = s ? e[a] = ne.pop() || pe.guid++ : a),
                 l[u] || (l[u] = s ? {} : {toJSON : pe.noop}),
                 "object" != typeof t && "function" != typeof t ||
                     (i ? l[u] = pe.extend(l[u], t)
                        : l[u].data = pe.extend(l[u].data, t)),
                 o = l[u], i || (o.data || (o.data = {}), o = o.data),
    ...
    function d(e, t, n) {
      if (Ie(e)) {
        var i, r, o = e.nodeType, a = o ? pe.cache : e,
                  s = o ? e[pe.expando] : pe.expando;
        if (a[s]) {
          if (t && (i = n ? a[s] : a[s].data)) {
            pe.isArray(t) ? t = t.concat(pe.map(t, pe.camelCase))
                          : t in i ? t = [ t ]
                                   : (t = pe.camelCase(t),
                                      t = t in i ? [ t ] : t.split(" ")),
                            r = t.length;
          ...
          (n || (delete a[s].data, u(a[s]))) &&
              (o ? pe.cleanData([ e ], !0)
                 : de.deleteExpando || a != a.window ? delete a[s]
                                                     : a[s] = void 0)
        }
      }
    }
    ...
    function h(e, t) {
      var n, i, r = 0,
                o = "undefined" != typeof e.getElementsByTagName
    ...
    function v(e, t, n, i, r) {
      for (var o, a, s, l, u, c, d, f = e.length, v = p(t), y = [], b = 0;
           f > b; b++)
        if (a = e[b], a || 0 === a)
          if ("object" === pe.type(a))
    ...
    function w(e, t, n, i, r, o) {
      ...
      return 1 === o &&
                 (a = r,
                  r = function(
                      e) { return pe().off(e), a.apply(this, arguments) },
                  r.guid = a.guid || (a.guid = pe.guid++)),
             e.each(function() { pe.event.add(this, t, r, i, n) })
    }
    function C(e, t) {
        ...
        "script" === n && t.text !== e.text
            ...
            : "object" === n
                  ? (t.parentNode && (t.outerHTML = e.outerHTML),
                     de.html5Clone && e.innerHTML && !pe.trim(t.innerHTML) &&
                         (t.innerHTML = e.innerHTML))
                  : "input" === n && qe.test(e.type)
                        ? (t.defaultChecked = t.checked = e.checked,
                           t.value !== e.value && (t.value = e.value))
                        : "option" === n ? t.defaultSelected = t.selected =
                                               e.defaultSelected
                                         : "input" !== n && "textarea" !== n ||
    ...
    function N(e, t, n, i) {
      t = oe.apply([], t);
      var r, o, a, s, l, u, c = 0, d = e.length, f = d - 1, p = t[0],
                            m = pe.isFunction(p);
      ...
      if (d && (u = v(t, e[0].ownerDocument, !1, e, i), r = u.firstChild,
                1 === u.childNodes.length && (u = r), r || i)) {
        for (s = pe.map(h(u, "script"), T), a = s.length; d > c; c++)
          ...
          n.call(e[c], o, c);
        if (a)
          for (l = s[s.length - 1].ownerDocument, pe.map(s, k), c = 0; a > c;
               c++)
            o = s[c],
            ze.test(o.type || "") && !pe._data(o, "globalEval") &&
                pe.contains(l, o) &&
                (o.src
                     ? pe._evalUrl && pe._evalUrl(o.src)
                     : pe.globalEval((o.text || o.textContent || o.innerHTML ||
                                      "").replace(ot, "")));
        u = r = null
      }
      return e
                 ...
                 (n = A(e, t),
                  "none" !== n && n ||
                      (lt =
                       ...
                       t = (lt[0].contentWindow || lt[0].contentDocument)
                               .document,
                       t.write(), t.close(), n = A(e, t), lt.detach()),
                  ut[e] = n),
             n
    }
    function _(e, t) {
    ...
    function D(e, t) {
      for (var n, i, r, o = [], a = 0, s = e.length; s > a; a++)
        i = e[a],
        i.style &&
            (o[a] = pe._data(i, "olddisplay"), n = i.style.display,
             t ? (o[a] || "none" !== n || (i.style.display = ""),
                  "" === i.style.display && Be(i) &&
      ...
      for (a = 0; s > a; a++)
        i = e[a],
        i.style && (t && "none" !== i.style.display && "" !== i.style.display ||
    ...
    function M(e, t, n) {
      ...
      if (0 >= r || null == r) {
        if (r = mt(e, t, o), (0 > r || null == r) && (r = e.style[t]),
            dt.test(r))
          return r;
    ...
    function P(e, t, n, i, r) { return new P.prototype.init(e, t, n, i, r) }
    function B() {
      return e.setTimeout(function() { Et = void 0 }), Et = pe.now()
    }
    function F(e, t) {
    ...
    function q(e, t, n) {
      for (var i, r = (R.tweeners[t] || []).concat(R.tweeners["*"]), o = 0,
                  a = r.length;
           a > o; o++)
        if (i = r[o].call(n, t, e))
          return i
    ...
    function $(e, t, n) {
      var i, r, o, a, s, l, u, c, d = this, f = {}, p = e.style,
                                  h = e.nodeType && Be(e),
                                  m = pe._data(e, "fxshow");
      n.queue || (s = pe._queueHooks(e, "fx"),
                  null == s.unqueued &&
                      (s.unqueued = 0, l = s.empty.fire,
                       s.empty.fire = function() { s.unqueued || l() }),
          ...
          1 === e.nodeType && ("height" in t || "width" in t) &&
              (n.overflow = [ p.overflow, p.overflowX, p.overflowY ],
               u = pe.css(e, "display"),
               c = "none" === u ? pe._data(e, "olddisplay") || j(e.nodeName)
                                : u,
               "inline" === c && "none" === pe.css(e, "float") &&
      ...
      if (pe.isEmptyObject(f))
        ...
        m ? "hidden" in m && (h = m.hidden)
          : m = pe._data(e, "fxshow", {}),
            o && (m.hidden = !h),
            h ? pe(e).show() : d.done(function() { pe(e).hide() }),
            d.done(function() {
              var t;
    ...
    function z(e, t) {
      var n, i, r, o, a;
      for (n in e)
        if (i = pe.camelCase(n), r = t[i], o = e[n],
            pe.isArray(o) && (r = o[1], o = e[n] = o[0]),
            n !== i && (e[i] = o, delete e[n]), a = pe.cssHooks[i],
            a && "expand" in a) {
    ...
    function R(e, t, n) {
      var i, r, o = 0, a = R.prefilters.length,
                ...
                u = s.promise({
                  ...
                  props : pe.extend({}, t),
                  opts : pe.extend(
                      !0, {specialEasing : {}, easing : pe.easing._default}, n),
      ...
      for (z(c, u.opts.specialEasing); a > o; o++)
        if (i = R.prefilters[o].call(u, e, c, u.opts))
          return pe.isFunction(i.stop) &&
                     (pe._queueHooks(u.elem, u.opts.queue).stop =
                          pe.proxy(i.stop, i)),
                 i;
      return pe.map(c, q, u),
             pe.isFunction(u.opts.start) && u.opts.start.call(e, u),
             pe.fx.timer(
                 pe.extend(l, {elem : e, anim : u, queue : u.opts.queue})),
             u.progress(u.opts.progress)
                 .done(u.opts.done, u.opts.complete)
                 .fail(u.opts.fail)
                 .always(u.opts.always)
    }
    function W(e) { return pe.attr(e, "class") || "" }
    function X(e) {
      return function(t, n) {
    ...
    function G(e, t, n, i) {
      ...
      for (o = c.shift(); o;)
        if (e.responseFields[o] && (n[e.responseFields[o]] = t),
            !l && i && e.dataFilter && (t = e.dataFilter(t, e.dataType)), l = o,
            o = c.shift())
          if ("*" === o)
            o = l;
          else if ("*" !== l && l !== o) {
    ...
    var ne = [], ie = e.document, re = ne.slice, oe = ne.concat, ae = ne.push,
        se = ne.indexOf, le = {}, ue = le.toString, ce = le.hasOwnProperty,
        de = {}, fe = "1.12.4",
        pe = function(e, t) { return new pe.fn.init(e, t) },
        he = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, me = /^-ms-/,
        ge = /-([\da-z])/gi, ve = function(e, t) { return t.toUpperCase() };
    pe.fn = pe.prototype = {
      jquery : fe,
      constructor : pe,
      selector : "",
    ...
    pe.extend = pe.fn.extend =
        function() {
      var e, t, n, i, r, o, a = arguments[0] || {}, s = 1, l = arguments.length,
                            u = !1;
      for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++),
        ...
        if (null != (r = arguments[s]))
          for (i in r)
            e = a[i], n = r[i],
            a !== n && (u && n && (pe.isPlainObject(n) || (t = pe.isArray(n)))
                            ? (t ? (t = !1, o = e && pe.isArray(e) ? e : [])
    ...
    pe.extend({
      ...
      makeArray : function(e, t) {
        var i = t || [];
        return null != e &&
                   (n(Object(e)) ? pe.merge(i, "string" == typeof e ? [ e ] : e)
                                 : ae.call(i, e)),
               i
      },
      inArray : function(e, t, n) {
        ...
        if (t) {
          ...
          for (i = t.length, n = n ? 0 > n ? Math.max(0, i + n) : n : 0; i > n;
               n++)
            if (n in t && t[n] === e)
              return n
        }
    ...
    pe.each(
        "Boolean Number String Function Array Date RegExp Object Error Symbol"
            .split(" "),
        function(e, t) { le["[object " + t + "]"] = t.toLowerCase() });
    var ye = function(e) {
      function t(e, t, n, i) {
        ...
        if (n = n || [],
          ...
          return n;
        if (!i &&
            ((t ? t.ownerDocument || t : q) !== I && _(t), t = t || I, H)) {
          if (11 !== m && (u = ve.exec(e)))
            if (r = u[1]) {
              if (9 === m) {
                ...
                if (a.id === r)
                  return n.push(a), n
              } else if (h && (a = h.getElementById(r)) && B(t, a) &&
                         a.id === r)
                return n.push(a), n
            } else {
              if (u[2])
                return J.apply(n, t.getElementsByTagName(e)), n;
              if ((r = u[3]) && w.getElementsByClassName &&
      ...
      function a(e, t) {
        var n = t && e, i = n && 1 === e.nodeType && 1 === t.nodeType &&
      ...
      function v(e, t, n, r, o, a) {
        return r && !r[F] && (r = v(r)), o && !o[F] && (o = v(o, a)),
               i(function(i, a, s, l) {
                 var u, c, d, f = [], p = [], h = a.length,
      ...
      function y(e) {
        for (var t, n, i,
             r = e.length, o = C.relative[e[0].type], a = o || C.relative[" "],
             s = o ? 1 : 0, l = p(function(e) { return e === t }, a, !0),
             u = p(function(e) { return ee(t, e) > -1 }, a, !0),
             c = [ function(e, n, i) {
               var r = !o && (i || n !== L) ||
          ...
          if (n = C.relative[e[s].type])
            ...
            if (n = C.filter[e[s].type].apply(null, e[s].matches), n[F]) {
              for (i = ++s; r > i && !C.relative[e[i].type]; i++)
                ;
              return v(s > 1 && h(c),
                       s > 1 && f(e.slice(0, s - 1).concat({
                                  value : " " === e[s - 2].type ? "*" : ""
                                })).replace(se, "$1"),
                       n, i > s && y(e.slice(s, i)), r > i && y(e = e.slice(i)),
                       r > i && f(e))
            }
            c.push(n)
          }
      ...
      function b(e, n) {
        var r = n.length > 0, o = e.length > 0, a = function(i, a, s, l, u) {
          var c, d, f, p = 0, h = "0", m = i && [], v = [], y = L,
                       b = i || o && C.find.TAG("*", u),
                       x = $ += null == y ? 1 : Math.random() || .1,
                       w = b.length;
          for (u && (L = a === I || a || u); h !== w && null != (c = b[h]);
               h++) {
            if (o && c) {
              for (d = 0, a || c.ownerDocument === I || (_(c), s = !H);
                   f = e[d++];)
                if (f(c, a || I, s)) {
                  l.push(c);
                  break
      ...
      var x, w, C, T, k, E, S, N, L, A, j, _, I, D, H, O, M, P, B,
          F = "sizzle" + 1 * new Date, q = e.document, $ = 0, z = 0, R = n(),
          W = n(), X = n(),
          Y = function(e, t) { return e === t && (j = !0), 0 }, U = 1 << 31,
          V = {}.hasOwnProperty, G = [], Q = G.pop, Z = G.push, J = G.push,
          K = G.slice,
          ee =
              function(e, t) {
          ...
          de = new RegExp(oe), fe = new RegExp("^" + ie + "$"), pe = {
            ID : new RegExp("^#(" + ie + ")"),
            CLASS : new RegExp("^\\.(" + ie + ")"),
            TAG : new RegExp("^(" + ie + "|[*])"),
            ATTR : new RegExp("^" + re),
          ...
          we = function(e, t, n) {
            var i = "0x" + t - 65536;
            return i !== i || n ? t
                                : 0 > i ? String.fromCharCode(i + 65536)
      ...
      try {
        ...
        J={apply:G.length?function(e,t){Z.apply(e,K.call(t))}:function(e,t){for(var n=e.length,i=0;e[n++]=t[i++];);e.length=n-1}}
      }
      w = t.support = {},
      k = t.isXML =
          function(e) {
      ...
      t.contains = function(
          e, t) { return (e.ownerDocument || e) !== I && _(e), B(e, t) },
      t.attr =
          function(e, t) {
        (e.ownerDocument || e) !== I && _(e);
        var n = C.attrHandle[t.toLowerCase()],
            i = n && V.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !H)
                                                           : void 0;
        return void 0 !== i
                   ? i
                   : w.attributes || !H
      ...
      t.error = function(
          e) { throw new Error("Syntax error, unrecognized expression: " + e) },
      t.uniqueSort =
          function(e) {
        var t, n = [], i = 0, r = 0;
        if (j = !w.detectDuplicates, A = !w.sortStable && e.slice(0), e.sort(Y),
            j) {
          for (; t = e[r++];)
            t === e[r] && (i = n.push(r));
          for (; i--;)
      ...
      C = t.selectors = {
        ...
        filter : {
            ...
            return 1 === i && 0 === r ? function(e) {
              ...
              if (g) {
                ...
                if (h = [ a ? g.firstChild : g.lastChild ], a && y) {
                  for (f = g, d = f[F] || (f[F] = {}),
                      c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [],
                      p = u[0] === $ && u[1], b = p && u[2],
                      f = p && g.childNodes[p];
                ...
                } else if (y && (f = t, d = f[F] || (f[F] = {}),
                                 c = d[f.uniqueID] || (d[f.uniqueID] = {}),
                                 u = c[e] || [], p = u[0] === $ && u[1], b = p),
                           b === !1)
                  for (; (f = ++p && f && f[m] || (b = p = 0) || h.pop()) &&
                         ((s ? f.nodeName.toLowerCase() !== v
                             : 1 !== f.nodeType) ||
                          !++b ||
                          (y && (d = f[F] || (f[F] = {}),
                                c = d[f.uniqueID] || (d[f.uniqueID] = {}),
          ...
          PSEUDO : function(e, n) {
            var r, o = C.pseudos[e] || C.setFilters[e.toLowerCase()] ||
            ...
            return r[F] ? i(function(e, t, n, i) {
              for (var o, a = r(e, null, i, []), s = e.length; s--;)
                (o = a[s]) && (e[s] = !(t[s] = o))
                        ...
                        : function(e, i, o) {
                            return t[0] = e, r(t, null, o, n), t[0] = null,
                                   !n.pop()
                          }
          }),
          has : i(function(
              e) { return function(n) { return t(e, n).length > 0 } }),
      ...
      for (x in {submit : !0, reset : !0})
        C.pseudos[x] = l(x);
      return d.prototype = C.filters = C.pseudos, C.setFilters = new d,
             E = t.tokenize =
                 function(e, n) {
             ...
             N = t.select =
               ...
               if (n = n || [], 1 === d.length) {
                 if (o = d[0] = d[0].slice(0),
                     o.length > 2 && "ID" === (a = o[0]).type && w.getById &&
                         9 === t.nodeType && H && C.relative[o[1].type]) {
                 ...
                 for (r = pe.needsContext.test(e) ? 0 : o.length;
                      r-- && (a = o[r], !C.relative[s = a.type]);)
                   if ((l = C.find[s]) &&
                       (i = l(a.matches[0].replace(xe, we),
             ...
             r(function(e) { return null == e.getAttribute("disabled") }) ||
                 o(te,
                   function(e, t, n) {
                     var i;
                     return n ? void 0
    ...
    pe.find = ye, pe.expr = ye.selectors, pe.expr[":"] = pe.expr.pseudos,
    pe.uniqueSort = pe.unique = ye.uniqueSort, pe.text = ye.getText,
    ...
    var ke,
        ...
        Se = pe.fn.init = function(e, t, n) {
          ...
          if (n = n || ke, "string" == typeof e) {
            if (i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) &&
                            e.length >= 3
                        ? [ null, e, null ]
                        : Ee.exec(e),
                !i || !i[1] && t)
              return !t || t.jquery ? (t || n).find(e)
          ...
          return e.nodeType
                     ...
                     : pe.isFunction(e)
                           ? "undefined" != typeof n.ready ? n.ready(e) : e(pe)
                           : (void 0 !== e.selector &&
    ...
    pe.fn.extend({
      ...
      closest : function(e, t) {
        for (var n,
             i = 0, r = this.length, o = [],
             a = we.test(e) || "string" != typeof e ? pe(e, t || this.context)
                                                    : 0;
             r > i; i++)
      ...
      index : function(e) {
        return e ? "string" == typeof e ? pe.inArray(this[0], pe(e))
      ...
      addBack : function(e) {
        ...
        pe.each({
          ...
          siblings : function(
              e) { return xe((e.parentNode || {}).firstChild, e) },
          children : function(e) { return xe(e.firstChild) },
          contents : function(e) {
    ...
    pe.Callbacks = function(e) {
      ...
      var t, n, i, r, a = [], s = [], l = -1, u = function() {
        for (r = e.once, i = t = !0; s.length; l = -1)
          for (n = s.shift(); ++l < a.length;)
            a[l].apply(n[0], n[1]) === !1 && e.stopOnFalse &&
                (l = a.length, n = !1);
        ...
        lock : function() { return r = !0, n || c.disable(), this },
        locked : function() { return !!r },
        fireWith : function(e, n) {
          return r || (n = n || [], n = [ e, n.slice ? n.slice() : n ],
                       s.push(n), t || u()),
                 this
        },
      ...
      Deferred : function(e) {
        var t =
            ...
            n = "pending", i = {
              ...
              always :
                  function() { return r.done(arguments).fail(arguments), this },
              then : function() {
                var e = arguments;
                return pe
                    .Deferred(function(n) {
      ...
      when : function(e) {
        var t, n, i,
            r = 0, o = re.call(arguments), a = o.length,
            s = 1 !== a || e && pe.isFunction(e.promise) ? a : 0,
            l = 1 === s ? e : pe.Deferred(), u = function(e, n, i) {
              return function(r) {
                n[e] = this,
        ...
        if (a > 1)
          for (t = new Array(a), n = new Array(a), i = new Array(a); a > r; r++)
            o[r] && pe.isFunction(o[r].promise) ? o[r].promise()
                                                      .progress(u(r, n, t))
                                                      .done(u(r, i, o))
                                                      .fail(l.reject)
                                                : --s;
    ...
    var je;
    pe.fn.ready = function(e) { return pe.ready.promise().done(e), this },
    pe.extend({
      isReady : !1,
      readyWait : 1,
    ...
    de.ownFirst = "0" === _e, de.inlineBlockNeedsLayout = !1, pe(function() {
      ...
      n && n.style &&
          (t = ie.createElement("div"), i = ie.createElement("div"),
           i.style.cssText =
    ...
    pe.extend({
      ...
      _removeData : function(e, t) { return d(e, t, !0) }
        ...
        pe.fn.extend({
          ...
          removeData : function(
              e) { return this.each(function() { pe.removeData(this, e) }) }
        }),
        pe.extend({
          queue : function(e, t, n) {
            var i;
            return e ? (t = (t || "fx") + "queue", i = pe._data(e, t),
                        n && (!i || pe.isArray(n)
          ...
          dequeue : function(e, t) {
            t = t || "fx";
            var n = pe.queue(e, t), i = n.length, r = n.shift(),
                o = pe._queueHooks(e, t), a = function() { pe.dequeue(e, t) };
            "inprogress" === r && (r = n.shift(), i--),
                r && ("fx" === t && n.unshift("inprogress"), delete o.stop,
                      r.call(e, a, o)),
                !i && o && o.empty.fire()
          },
            ...
            return "string" != typeof e && (t = e, e = "fx", n--),
                   arguments.length < n
                       ...
                       : void 0 === t ? this : this.each(function() {
                           ...
                           pe._queueHooks(this, e), "fx" === e &&
                                                        "inprogress" !== n[0] &&
                                                        pe.dequeue(this, e)
                         })
          },
          dequeue : function(
              e) { return this.each(function() { pe.dequeue(this, e) }) },
          clearQueue : function(e) { return this.queue(e || "fx", []) },
          promise : function(e, t) {
            var n, i = 1, r = pe.Deferred(), o = this, a = this.length,
                       ...
                       ? (t = ie.createElement("div"),
                          ...
                          "undefined" != typeof t.style.zoom &&
                              (t.style.cssText =
                               ...
                               t.appendChild(ie.createElement("div"))
                                   .style.width = "5px",
                               e = 3 !== t.offsetWidth),
                          n.removeChild(i), e)
                       : void 0
          ...
          if ("object" === pe.type(n)) {
            ...
            for (s in n)
              Fe(e, t, s, n[s], !0, o, a)
                     ...
                     (r = !0, pe.isFunction(i) || (a = !0),
                      u && (a ? (t.call(e, i), t = null)
                              : (u = t,
                                 t = function(e, t,
                                              n) { return u.call(pe(e), n) })),
                      t))
            for (; l > s; s++)
              t(e[s], n, a ? i : i.call(e[s], s, t(e[s], n)));
          return r ? e : u ? t.call(e) : l ? t(e[0], n) : o
        },
        qe = /^(?:checkbox|radio)$/i, $e = /<([\w:-]+)/,
        ze = /^$|\/(?:java|ecma)script/i, Re = /^\s+/,
        We =
            "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video";
    !function() {
      var e = ie.createElement("div"), t = ie.createDocumentFragment(),
      ...
      de.appendChecked = n.checked, e.innerHTML = "<textarea>x</textarea>",
      de.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue,
      t.appendChild(e), n = ie.createElement("input"),
      n.setAttribute("type", "radio"), n.setAttribute("checked", "checked"),
      n.setAttribute("name", "t"), e.appendChild(n),
      de.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked,
      de.noCloneEvent = !!e.addEventListener, e[pe.expando] = 1,
    ...
    pe.extend({
      ...
      clone : function(e, t, n) {
        ...
        if (de.html5Clone || pe.isXMLDoc(e) || !et.test("<" + e.nodeName + ">")
                ? o = e.cloneNode(!0)
                : (st.innerHTML = e.outerHTML,
                   st.removeChild(o = st.firstChild)),
            !(de.noCloneEvent && de.noCloneChecked ||
              1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e)))
        ...
        if (t)
          if (n)
            ...
            E(e, o);
        return i = h(o, "script"), i.length > 0 && m(i, !l && h(e, "script")),
               i = s = r = null, o
      },
      cleanData : function(e, t) {
        for (var n, i, r, o, a = 0, s = pe.expando, l = pe.cache,
                             u = de.attributes, c = pe.event.special;
             null != (n = e[a]); a++)
          if ((t || Ie(n)) && (r = n[s], o = r && l[r])) {
            if (o.events)
              for (i in o.events)
        ...
        pe.fn.extend({
          ...
          clone : function(e, t) {
            return e = null == e ? !1 : e, t = null == t ? e : t,
                   this.map(function() { return pe.clone(this, e, t) })
          },
          html : function(e) {
            return Fe(this, function(e) {
        ...
        pe.each({
          ...
          replaceAll : "replaceWith"
                ...
                function(e, t) {
                  pe.fn[e] = function(e) {
                    for (var n, i = 0, r = [], o = pe(e), a = o.length - 1;
                         a >= i; i++)
                      n = i === a ? this : this.clone(!0), pe(o[i])[t](n),
                      ae.apply(r, n.get());
                    return this.pushStack(r)
                  }
                });
    var lt, ut = {HTML : "block", BODY : "block"}, ct = /^margin/,
    ...
    !function() {
      function t() {
        ...
        d.appendChild(l),
         ...
         n = r = s = !1, i = a = !0,
         e.getComputedStyle &&
             (c = e.getComputedStyle(u), n = "1%" !== (c || {}).top,
              s = "2px" === (c || {}).marginLeft,
              ...
              u.removeChild(t)),
         u.style.display = "none", o = 0 === u.getClientRects().length,
         o && (u.style.display = "",
               ...
               o && (t[0].style.display = "", t[1].style.display = "none",
                     o = 0 === t[0].offsetHeight)),
         d.removeChild(l)
      }
      ...
      u.style &&
          (u.style.cssText = "float:left;opacity:.5",
           ...
           de.boxSizing = "" === u.style.boxSizing ||
                          "" === u.style.MozBoxSizing ||
                          "" === u.style.WebkitBoxSizing,
           pe.extend(de, {
             reliableHiddenOffsets : function() { return null == n && t(), o },
             boxSizingReliable : function() { return null == n && t(), r },
             pixelMarginRight : function() { return null == n && t(), i },
               ...
               function(e, t, n) {
                 ...
                 return n = n || ht(e),
                        ...
                        "" !== a && void 0 !== a ||
                            pe.contains(e.ownerDocument, e) ||
                            (a = pe.style(e, t)),
                        n && !de.pixelMarginRight() && dt.test(a) &&
                            ct.test(t) &&
                            (i = s.width, r = s.minWidth, o = s.maxWidth,
                             s.minWidth = s.maxWidth = s.width = a, a = n.width,
                             s.width = i, s.minWidth = r, s.maxWidth = o),
                        void 0 === a ? a : a + ""
               })
        : pt.currentStyle &&
              (ht = function(e) { return e.currentStyle },
               mt =
                   function(e, t, n) {
                     var i, r, o, a, s = e.style;
                     return n = n || ht(e), a = n ? n[t] : void 0,
                            null == a && s && s[t] && (a = s[t]),
                            dt.test(a) && !gt.test(t) &&
                                (i = s.left, r = e.runtimeStyle,
                                 o = r && r.left,
                                 o && (r.left = e.currentStyle.left),
                                 s.left = "fontSize" === t ? "1em" : a,
                                 a = s.pixelLeft + "px", s.left = i,
                                 o && (r.left = o)),
                            void 0 === a ? a : a + "" || "auto"
                   });
    var vt = /alpha\([^)]*\)/i, yt = /opacity\s*=\s*([^)]*)/i,
        bt = /^(none|table(?!-c[ea]).+)/,
        xt = new RegExp("^(" + Oe + ")(.*)$", "i"),
        wt = {position : "absolute", visibility : "hidden", display : "block"},
        Ct = {letterSpacing : "0", fontWeight : "400"},
        Tt = [ "Webkit", "O", "Moz", "ms" ], kt = ie.createElement("div").style;
    pe.extend({
      cssHooks : {
        opacity : {
          get : function(e, t) {
      ...
      style : function(e, t, n, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (t = pe.cssProps[s] || (pe.cssProps[s] = I(s) || s),
              a = pe.cssHooks[t] || pe.cssHooks[s], void 0 === n)
            return a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r
                                                                       : l[t];
          if (o = typeof n,
              "string" === o && (r = Me.exec(n)) && r[1] &&
                  (n = f(e, t, r), o = "number"),
              null != n && n === n &&
                  ("number" === o &&
                       (n += r && r[3] || (pe.cssNumber[s] ? "" : "px")),
                   de.clearCloneStyle || "" !== n ||
      ...
      css : function(e, t, n, i) {
        ...
        return t = pe.cssProps[s] || (pe.cssProps[s] = I(s) || s),
        ...
        pe.each([ "height", "width" ],
                function(e, t) {
                  pe.cssHooks[t] = {
                    get : function(e, n, i) {
                      return n ? bt.test(pe.css(e, "display")) &&
                                         0 === e.offsetWidth
                                     ? ft(e, wt,
                                          function() { return M(e, t, i) })
                                     : M(e, t, i)
                               : void 0
                    },
                    set : function(e, n, i) {
        ...
        de.opacity || (pe.cssHooks.opacity = {
          get : function(e, t) {
            return yt.test((t && e.currentStyle ? e.currentStyle.filter
                                                : e.style.filter) ||
                           "")
        ...
        pe.cssHooks
            .marginRight = _(de.reliableMarginRight,
                             function(e, t) {
                               return t ? ft(e, {display : "inline-block"}, mt,
                                             [ e, "marginRight" ])
                                        : void 0
                             }),
 pe.cssHooks.marginLeft =
        _(de.reliableMarginLeft,
          function(e, t) {
            return t ? (parseFloat(mt(e, "marginLeft")) ||
                        (pe.contains(e.ownerDocument, e)
 ...
 pe.each({margin : "", padding : "", border : "Width"},
         function(e, t) {
           pe.cssHooks[e + t] = {
             expand : function(n) {
               for (var i = 0, r = {},
 ...
 pe.Tween = P, P.prototype = {
   ...
   init : function(e, t, n, i, r, o) {
     this.elem = e, this.prop = n, this.easing = r || pe.easing._default,
 ...
 P.prototype.init.prototype = P.prototype, P.propHooks = {
   _default : {
     ...
     set : function(e) {
       pe.fx.step[e.prop] ? pe.fx.step[e.prop](e)
                          : 1 !== e.elem.nodeType ||
 ...
 P.propHooks.scrollTop = P.propHooks.scrollLeft = {
   set : function(
       e) { e.elem.nodeType && e.elem.parentNode && (e.elem[e.prop] = e.now) }
 },
 pe.easing = {
 ...
 pe.fx = P.prototype.init, pe.fx.step = {};
    ...
    pe.Animation = pe.extend(R, {
      ...
      tweener : function(e, t) {
        ...
        for (var n, i = 0, r = e.length; r > i; i++)
          n = e[i], R.tweeners[n] = R.tweeners[n] || [],
          R.tweeners[n].unshift(t)
      },
      prefilters : [ $ ],
      prefilter : function(
          e, t) { t ? R.prefilters.unshift(e) : R.prefilters.push(e) }
    }),
    pe.speed =
        function(e, t, n) {
    ...
    pe.fn.extend({
      ...
      stop : function(e, t, n) {
        ...
        return "string" != typeof e && (n = t, t = e, e = void 0),
               ...
               this.each(function() {
                 var t = !0, r = null != e && e + "queueHooks", o = pe.timers,
                     a = pe._data(this);
                 if (r)
                   a[r] && a[r].stop && i(a[r]);
                 else
                 ...
                 for (r = o.length; r--;)
                   o[r].elem !== this || null != e && o[r].queue !== e ||
      ...
      finish : function(e) {
        return e !== !1 && (e = e || "fx"), this.each(function() {
          var t, n = pe._data(this), i = n[e + "queue"],
                 r = n[e + "queueHooks"], o = pe.timers, a = i ? i.length : 0;
    ...
    pe.each({
      ...
      fadeToggle : {opacity : "toggle"}
            ...
            function(e, t) {
              pe.fn[e] = function(e, n, i) { return this.animate(t, e, n, i) }
            }),
    pe.timers = [],
    pe.fx.tick =
        function() {
    ...
    pe.fx.timer = function(
        e) { pe.timers.push(e), e() ? pe.fx.start() : pe.timers.pop() },
    pe.fx.interval = 13,
    pe.fx.start =
        function() { St || (St = e.setInterval(pe.fx.tick, pe.fx.interval)) },
    pe.fx.stop = function() { e.clearInterval(St), St = null },
    pe.fx.speeds = {slow : 600, fast : 200, _default : 400},
    pe.fn.delay = function(t, n) {
      return t = pe.fx ? pe.fx.speeds[t] || t : t, n = n || "fx",
             this.queue(n, function(n, i) {
               var r = e.setTimeout(n, t);
               i.stop = function() { e.clearTimeout(r) }
             })
    }, function() {
      var e, t = ie.createElement("input"), n = ie.createElement("div"),
             i = ie.createElement("select"),
             r = i.appendChild(ie.createElement("option"));
      n = ie.createElement("div"), n.setAttribute("className", "t"),
      n.innerHTML =
          "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",
      e = n.getElementsByTagName("a")[0], t.setAttribute("type", "checkbox"),
      n.appendChild(t), e = n.getElementsByTagName("a")[0],
      e.style.cssText = "top:1px", de.getSetAttribute = "t" !== n.className,
      de.style = /top/.test(e.getAttribute("style")),
      de.hrefNormalized = "/a" === e.getAttribute("href"),
      de.checkOn = !!t.value, de.optSelected = r.selected,
      de.enctype = !!ie.createElement("form").enctype, i.disabled = !0,
      de.optDisabled = !r.disabled, t = ie.createElement("input"),
      t.setAttribute("value", ""), de.input = "" === t.getAttribute("value"),
      t.value = "t", t.setAttribute("type", "radio"),
    ...
    pe.fn.extend({
      val : function(e) {
        ...
        return arguments.length
                   ? (i = pe.isFunction(e), this.each(function(n) {
                       var r;
                       1 === this.nodeType &&
                   ...
                   : r ? (t = pe.valHooks[r.type] ||
                              pe.valHooks[r.nodeName.toLowerCase()],
                          t && "get" in t && void 0 !== (n = t.get(r, "value"))
                              ? n
                              : (n = r.value, "string" == typeof n
                                                  ? n.replace(At, "")
                                                  : null == n ? "" : n))
                       : void 0
      }
        ...
        pe.extend({
          valHooks : {
            ...
            select : {
              get : function(e) {
                for (var t, n, i = e.options, r = e.selectedIndex,
        ...
        pe.each([ "radio", "checkbox" ], function() {
          pe.valHooks[this] = {
            set : function(e, t) {
              return pe.isArray(t) ? e.checked = pe.inArray(pe(e).val(), t) > -1
                                   : void 0
            }
          },
    ...
    var _t, It, Dt = pe.expr.attrHandle, Ht = /^(?:checked|selected)$/i,
                Ot = de.getSetAttribute, Mt = de.input;
    pe.fn.extend({
      attr : function(
          e, t) { return Fe(this, pe.attr, e, t, arguments.length > 1) },
      removeAttr : function(
          e) { return this.each(function() { pe.removeAttr(this, e) }) }
    }),
        pe.extend({
          attr : function(e, t, n) {
        ...
        pe.each(pe.expr.match.bool.source.match(/\w+/g),
                function(e, t) {
                  ...
                  Mt && Ot || !Ht.test(t) ? Dt[t] = function(e, t, i) {
                    var r, o;
                    return i ||
                               (o = Dt[t], Dt[t] = r,
                    ...
                    return n ? void 0
                             : e[pe.camelCase("default-" + t)] ? t.toLowerCase()
                                                               : null
                  }
                }),
        Mt && Ot || (pe.attrHooks.value = {
          set : function(e, t, n) {
            return pe.nodeName(e, "input") ? void (e.defaultValue = t)
                                           : _t && _t.set(e, t, n)
          }
        }),
        Ot || (_t = {
          set : function(e, t, n) {
            ...
            return i || e.setAttributeNode(
                            i = e.ownerDocument.createAttribute(n)),
                   i.value = t += "",
                   "value" === n || t === e.getAttribute(n) ? t : void 0
          }
        },
               Dt.id = Dt.name = Dt.coords =
                   function(e, t, n) {
                     var i;
                     return n ? void 0
               ...
               pe.attrHooks.contenteditable = {
                 set : function(e, t, n) { _t.set(e, "" === t ? !1 : t, n) }
               },
               pe.each([ "width", "height" ],
                       function(e, t) {
                         pe.attrHooks[t] = {
                           set : function(e, n) {
                             return "" === n ? (e.setAttribute(t, "auto"), n)
                                             : void 0
                           }
                         }
                       })),
    ...
    pe.fn.extend({
      prop : function(
          e, t) { return Fe(this, pe.prop, e, t, arguments.length > 1) },
      removeProp : function(e) {
        ...
        pe.each(
            ...
            function() { pe.propFix[this.toLowerCase()] = this }),
    ...
    pe.fn.extend({
      addClass : function(e) {
        ...
        if (pe.isFunction(e))
          return this.each(function(
              t) { pe(this).addClass(e.call(this, t, W(this))) });
      ...
      removeClass : function(e) {
        ...
        if (pe.isFunction(e))
          return this.each(function(
              t) { pe(this).removeClass(e.call(this, t, W(this))) });
        if (!arguments.length)
        ...
        return "boolean" == typeof t && "string" === n
                   ...
                   : pe.isFunction(e)
                         ? this.each(function(n) {
                             pe(this).toggleClass(e.call(this, n, W(this), t),
                                                  t)
                           })
                         : this.each(function() {
                             var t, i, r, o;
                             if ("string" === n)
                               for (i = 0, r = pe(this), o = e.match(Ae) || [];
                                    t = o[i++];)
    ...
    pe.parseJSON = function(t) {
      ...
      try {
        e.DOMParser
            ...
            : (n = new e.ActiveXObject("Microsoft.XMLDOM"), n.async = "false",
               n.loadXML(t))
      } catch (r) {
        n = void 0
      }
    ...
    pe.extend({
      ...
      ajaxSetup : function(
          e,
          t) { return t ? U(U(e, pe.ajaxSettings), t) : U(pe.ajaxSettings, e) },
      ajaxPrefilter : X(Zt),
      ajaxTransport : X(Jt),
      ajax : function(t, n) {
        function i(t, n, i, r) {
          ...
          2 !== x &&
              (x = 2, l && e.clearTimeout(l), c = void 0, s = r || "",
               ...
               C.status = t, C.statusText = (n || T) + "",
               o ? m.resolveWith(p, [ d, T, C ]) : m.rejectWith(p, [ C, T, y ]),
               C.statusCode(v), v = void 0,
               u && h.trigger(o ? "ajaxSuccess" : "ajaxError",
                              [ C, f, o ? d : y ]),
               g.fireWith(p, [ C, T ]),
        ...
        var r, o, a, s, l, u, c, d,
            f = pe.ajaxSetup({}, n), p = f.context || f,
            h = f.context && (p.nodeType || p.jquery) ? pe(p) : pe.event,
            m = pe.Deferred(), g = pe.Callbacks("once memory"),
            v = f.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", C = {
              readyState : 0,
        ...
        if (m.promise(C).complete = g.add, C.success = C.done, C.error = C.fail,
            f.url = ((t || f.url || en) + "")
                        .replace(Wt, "")
                        .replace(Gt, tn[1] + "//"),
            f.type = n.method || n.type || f.method || f.type,
            f.dataTypes =
                pe.trim(f.dataType || "*").toLowerCase().match(Ae) || [ "" ],
            null == f.crossDomain &&
            ...
            f.data && f.processData && "string" != typeof f.data &&
                (f.data = pe.param(f.data, f.traditional)),
            Y(Zt, f, n, C), 2 === x)
          return C;
        u = pe.event && f.global,
        u && 0 === pe.active++ && pe.event.trigger("ajaxStart"),
        f.type = f.type.toUpperCase(), f.hasContent = !Vt.test(f.type),
        a = f.url,
        f.hasContent ||
            (f.data && (a = f.url += (zt.test(a) ? "&" : "?") + f.data,
                        delete f.data),
             f.cache === !1 &&
                 (f.url = Xt.test(a)
                              ? a.replace(Xt, "$1_=" + $t++)
        ...
        if (c = Y(Jt, f, n, C)) {
          if (C.readyState = 1, u && h.trigger("ajaxSend", [ C, f ]), 2 === x)
            return C;
          f.async && f.timeout > 0 &&
              (l = e.setTimeout(function() { C.abort("timeout") }, f.timeout));
          try {
            x = 1, c.send(y, i)
          } catch (T) {
            if (!(2 > x))
      ...
      getScript : function(e, t) { return pe.get(e, void 0, t, "script") }
        ...
        pe.fn.extend({
          wrapAll : function(e) {
            if (pe.isFunction(e))
              return this.each(function(
                  t) { pe(this).wrapAll(e.call(this, t)) });
            if (this[0]) {
          ...
          wrapInner : function(e) {
            return pe.isFunction(e)
                       ? this.each(function(
                             t) { pe(this).wrapInner(e.call(this, t)) })
                       : this.each(function() {
          ...
          wrap : function(e) {
            ...
            return this.each(function(
                n) { pe(this).wrapAll(t ? e.call(this, n) : e) })
          },
          unwrap : function() {
            return this.parent()
                .each(function() {
        ...
        pe.expr.filters.visible = function(
            e) { return !pe.expr.filters.hidden(e) };
    var nn = /%20/g, rn = /\[\]$/, on = /\r?\n/g,
    ...
    pe.param =
      ...
      if (void 0 === t && (t = pe.ajaxSettings && pe.ajaxSettings.traditional),
        ...
        pe.each(e, function() { r(this.name, this.value) });
      else
        for (n in e)
          J(n, e[n], t, r);
    ...
    e.attachEvent && e.attachEvent("onunload",
        ...
        de.cors = !!cn && "withCredentials" in cn, cn = de.ajax = !!cn,
        ...
        pe.ajaxSetup({
          ...
          converters :
              {"text script" : function(e) { return pe.globalEval(e), e }}
        }),
        pe.ajaxPrefilter("script", function(e) {
          ...
          if (e.crossDomain) {
            ...
            return {
              send: function(i, r) {
                t = ie.createElement("script"), t.async = !0,
      ...
      jsonpCallback : function() {
        ...
        pe.ajaxPrefilter("json jsonp", function(t, n, i) {
          ...
          return i ? [ t.createElement(i[1]) ]
                   : (i = v([ e ], t, r), r && r.length && pe(r).remove(),
    ...
    pe.fn.load =
      ...
      return s > -1 && (i = pe.trim(e.slice(s, e.length)), e = e.slice(0, s)),
             pe.isFunction(t) ? (n = t, t = void 0)
             ...
             a.length > 0 &&
                 pe.ajax({
                     ...
                     .done(function(e) {
                       o = arguments,
                       a.html(i ? pe("<div>").append(pe.parseHTML(e)).find(i)
                                : e)
                     })
                     .always(n &&
                             function(e, t) {
    ...
    pe.each(
        ...
        function(e, t) { pe.fn[t] = function(e) { return this.on(t, e) } }),
    pe.expr.filters.animated =
        function(e) {
    ...
    pe.offset = {
      setOffset : function(e, t, n) {
        ...
        "static" === c && (e.style.position = "relative"),
            s = d.offset(), o = pe.css(e, "top"), l = pe.css(e, "left"),
            u = ("absolute" === c || "fixed" === c) &&
                pe.inArray("auto", [ o, l ]) > -1,
            u ? (i = d.position(), a = i.top, r = i.left)
    ...
    pe.fn.extend({
      offset : function(e) {
        if (arguments.length)
          return void 0 === e ? this
                              : this.each(function(
                                    t) { pe.offset.setOffset(this, e, t) });
        var t, n, i = {top : 0, left : 0}, r = this[0],
                  o = r && r.ownerDocument;
        return o ? (t = o.documentElement,
                    pe.contains(t, r)
                        ? ("undefined" != typeof r.getBoundingClientRect &&
                           ...
                           n = te(o), {
                             top : i.top + (n.pageYOffset || t.scrollTop) -
                                       (t.clientTop || 0),
                             left : i.left + (n.pageXOffset || t.scrollLeft) -
                                        (t.clientLeft || 0)
                           })
                        : i)
                 : void 0
      ...
      position : function() {
        if (this[0]) {
          ...
          return "fixed" === pe.css(i, "position")
            ...
            function(e, t) {
              ...
              pe.fn[e] = function(i) {
                return Fe(this, function(e, i, r) {
                  var o = te(e);
                  return void 0 === r
                             ? o ? t in o ? o[t] : o.document.documentElement[i]
                                 : e[i]
                             : void (o ? o.scrollTo(n ? pe(o).scrollLeft() : r,
                                                    n ? r : pe(o).scrollTop())
                                       : e[i] = r)
    ...
    pe.each({Height : "height", Width : "width"},
            function(e, t) {
              pe.each(
                    ...
                    pe.fn[i] = function(i, r) {
                      ...
                      return Fe(this, function(t, n, i) {
                        ...
                        return pe.isWindow(t)
                                   ...
                                   : 9 === t.nodeType
                                         ? (r = t.documentElement,
                                            Math.max(t.body["scroll" + e],
                                                     r["scroll" + e],
                                                     t.body["offset" + e],
                                                     r["offset" + e],
                                                     r["client" + e]))
                                         : void 0 === i ? pe.css(t, n, a)
                                                        : pe.style(t, n, i, a)
                      }, t, o ? i : void 0, o, null)
                    }
                  })
    ...
    "function" == typeof define && define.amd &&
        define("jquery", [], function() { return pe });
    var hn = e.jQuery, mn = e.$;
    return pe.noConflict = function(t) {
      return e.$ === pe && (e.$ = mn), t && e.jQuery === pe && (e.jQuery = hn),
             pe
    }, t || (e.jQuery = e.$ = pe), pe
  }),
    function(e) {
      ...
      e.fn.fitVids = function(t) {
        ...
        return t && e.extend(n, t), this.each(function() {
          var t = [
            ...
            'iframe[src*="kickstarter.com"][src*="video.html"]', "object",
            "embed"
          ];
...
var $nav = $("#site-nav"), $btn = $("#site-nav button"),
...
$(window).resize(function() { updateNav() }),
    ...
    function(e) {
      var t, n, i, r, o, a, s,
          l = "Close", u = "BeforeClose", c = "AfterClose", d = "BeforeAppend",
          f = "MarkupParse", p = "Open", h = "Change", m = "mfp", g = "." + m,
          v = "mfp-ready", y = "mfp-removing", b = "mfp-prevent-close",
          x = function() {}, w = !!window.jQuery, C = e(window),
          T = function(e, n) { t.ev.on(m + e + g, n) },
          k = function(t, n, i, r) {
            var o = document.createElement("div");
            return o.className = "mfp-" + t, i && (o.innerHTML = i),
                   r ? n && n.appendChild(o) : (o = e(o), n && o.appendTo(n)), o
          }, E = function(n, i) {
            ...
            return n === s && t.currTemplate.closeBtn ||
                       (t.currTemplate.closeBtn =
                            e(t.st.closeMarkup.replace("%title%", t.st.tClose)),
                        s = n),
                   t.currTemplate.closeBtn
          }, N = function() {
      ...
      x.prototype = {
        ...
        init : function() {
          ...
          t.isIE8 = -1 !== n.indexOf("MSIE 8."), t.isLowIE = t.isIE7 || t.isIE8,
          t.isAndroid = /android/gi.test(n),
          t.isIOS = /iphone|ipad|ipod/gi.test(n), t.supportsTransition = L(),
          t.probablyMobile =
              t.isAndroid || t.isIOS ||
        ...
        open : function(n) {
          ...
          t.st.modal &&
              (t.st.closeOnContentClick = !1, t.st.closeOnBgClick = !1,
               t.st.showCloseBtn = !1, t.st.enableEscapeKey = !1),
          t.bgOverlay ||
              (t.bgOverlay = k("bg").on("click" + g, function() { t.close() }),
               t.wrap =
                   k("wrap")
                       .attr("tabindex", -1)
                       .on("click" + g,
                           function(
                               e) { t._checkIfClose(e.target) && t.close() }),
          ...
          E("BeforeOpen"),
              t.st.showCloseBtn &&
                  (t.st.closeBtnInside
                       ? (T(f, function(e, t, n,
                                        i) { n.close_replaceWith = S(i.type) }),
                          a += " mfp-close-btn-in")
                       : t.wrap.append(S())),
              ...
              t.st.enableEscapeKey &&
                  r.on("keyup" + g,
                       function(e) { 27 === e.keyCode && t.close() }),
              C.on("resize" + g, function() { t.updateSize() }),
          ...
          t.fixedContentPos &&
              (t.isIE7 ? e("body, html").css("overflow", "hidden")
                       : h.overflow = "hidden");
          var y = t.st.mainClass;
          return t.isIE7 && (y += " mfp-ie7"), y && t._addClassToMFP(y),
                 t.updateItemHTML(), E("BuildControls"), e("html").css(h),
          ...
          t.isOpen &&
              (E(u), t.isOpen = !1,
               t.st.removalDelay && !t.isLowIE && t.supportsTransition
                   ? (t._addClassToMFP(y),
                      setTimeout(function() { t._close() }, t.st.removalDelay))
                   : t._close())
        },
        _close : function() {
          E(l);
          ...
          r.off("keyup" + g + " focusin" + g), t.ev.off(g),
        ...
        updateItemHTML : function() {
          ...
          var a = t["get" + i.charAt(0).toUpperCase() + i.slice(1)](
              n, t.currTemplate[i]);
          t.appendContent(a, i), n.preloaded = !0, E(h, n), o = n.type,
                                 t.container.prepend(t.contentContainer),
                                 E("AfterChange")
        },
        appendContent : function(e, n) {
          t.content = e,
          e ? t.st.showCloseBtn && t.st.closeBtnInside &&
                      t.currTemplate[n] === !0
                  ? t.content.find(".mfp-close").length || t.content.append(S())
                  : t.content = e
            : t.content = "",
          E(d), t.container.addClass("mfp-" + n + "-holder"),
          t.contentContainer.append(t.content)
        },
        parseEl : function(n) {
          var i, r = t.items[n];
          if (r.tagName ? r = {el : e(r)}
          ...
          return r.type = i || t.st.type || "inline", r.index = n,
                 r.parsed = !0, t.items[n] = r, E("ElementParse", r), t.items[n]
        },
        addGroup : function(e, n) {
          ...
          n.items
              ...
              : (n.isObj = !1, n.delegate ? e.off(r).on(r, n.delegate, i)
                                          : (n.items = e, e.off(r).on(r, i)))
        },
        _openClick : function(n, i, r) {
          var o = void 0 !== r.midClick ? r.midClick
                                        : e.magnificPopup.defaults.midClick;
          if (o || 2 !== n.which && !n.ctrlKey && !n.metaKey) {
            var a = void 0 !== r.disableOn ? r.disableOn
            ...
            n.type && (n.preventDefault(), t.isOpen && n.stopPropagation()),
                r.el = e(n.mfpEl), r.delegate && (r.items = i.find(r.delegate)),
                t.open(r)
          }
        },
        updateStatus : function(e, i) {
          if (t.preloader) {
            ...
            E("UpdateStatus", r),
                e = r.status, i = r.text, t.preloader.html(i),
                t.preloader.find("a").on(
        ...
        _checkIfClose : function(n) {
          if (!e(n).hasClass(b)) {
            ...
            if (i && r)
              return !0;
            if (!t.content || e(n).hasClass("mfp-close") ||
        ...
        _addClassToMFP : function(
            e) { t.bgOverlay.addClass(e), t.wrap.addClass(e) },
        _removeClassFromMFP : function(
            e) { this.bgOverlay.removeClass(e), t.wrap.removeClass(e) },
        _hasScrollBar : function(e) {
          return (t.isIE7 ? r.height() : document.body.scrollHeight) >
                 (e || C.height())
        },
        _setFocus : function() {
        ...
        _parseMarkup : function(t, n, i) {
          var r;
          i.data && (n = e.extend(i.data, n)), E(f, [ t, n, i ]),
      ...
      e.magnificPopup = {
        ...
        modules : [],
        open : function(t, n) {
          return N(), t = t ? e.extend(!0, {}, t) : {}, t.isObj = !0,
                      t.index = n || 0, this.instance.open(t)
        },
        close : function() {
      ...
      var A, j, _,
          I = "inline",
          D = function() { _ && (j.after(_.addClass(A)).detach(), _ = null) };
      e.magnificPopup.registerModule(I, {
        ...
        proto : {
          initInline : function() {
            t.types.push(I), T(l + "." + I, function() { D() })
          },
      ...
      var H, O = "ajax", M = function() { H && i.removeClass(H) },
             P = function() { M(), t.req && t.req.abort() };
      e.magnificPopup.registerModule(O, {
        ...
        proto : {
          initAjax : function() {
            t.types.push(O), H = t.st.ajax.cursor, T(l + "." + O, P),
                             T("BeforeChange." + O, P)
          },
          getAjax : function(n) {
            ...
            var r = e.extend({
              ...
              success : function(i, r, o) {
                var a = {data : i, xhr : o};
                E("ParseAjax", a), t.appendContent(e(a.data), O),
                    n.finished = !0, M(), t._setFocus(),
                    setTimeout(function() { t.wrap.addClass(v) }, 16),
                    t.updateStatus("ready"), E("AjaxContentAdded")
              },
              error : function() {
                M(), n.finished = n.loadError = !0,
        ...
        proto : {
          ...
          resizeImage : function() {
            ...
            if (e && e.img && t.st.image.verticalFit) {
              var n = 0;
              t.isLowIE && (n = parseInt(e.img.css("padding-top"), 10) +
                                parseInt(e.img.css("padding-bottom"), 10)),
                  e.img.css("max-height", t.wH - n)
            }
          },
          _onImageHasSize : function(e) {
            e.img && (e.hasSize = !0, B && clearInterval(B),
                      e.isCheckingImgSize = !1, E("ImageHasSize", e),
                      e.imgHidden &&
          ...
          getImage : function(n, i) {
              ...
              n &&
                  (n.img[0].complete
                       ? (n.img.off(".mfploader"),
                          ...
                          n.hasSize = !0, n.loaded = !0, E("ImageLoadComplete"))
            ...
            if (l.length) {
              ...
              u.src = n.src, l.is("img") && (n.img = n.img.clone()),
              u = n.img[0],
              u.naturalWidth > 0 ? n.hasSize = !0 : u.width || (n.hasSize = !1)
            }
            return t._parseMarkup(i, {title : F(n), img_replaceWith : n.img},
                                  n),
                   t.resizeImage(),
                   n.hasSize
                       ? (B && clearInterval(B),
                          n.loadError
                              ? (i.addClass("mfp-loading"),
                                 t.updateStatus(
                                     "error", s.tError.replace("%url%", n.src)))
                              : (i.removeClass("mfp-loading"),
                                 t.updateStatus("ready")),
                          i)
                       : (t.updateStatus("loading"), n.loading = !0,
                          n.hasSize ||
                              (n.imgHidden = !0, i.addClass("mfp-loading"),
                               t.findImageSize(n)),
                          i)
          }
        }
      ...
      e.magnificPopup.registerModule("zoom", {
        ...
        proto : {
            ...
            if (n.enabled && t.supportsTransition) {
              var r, o, a = n.duration, s = function(e) {
                var t = e.clone()
                    ...
                    o = "transition";
                return r["-webkit-" + o] = r["-moz-" + o] = r["-o-" + o] =
                           r[o] = i,
                                      t.css(r), t
              ...
              T("BuildControls" + i, function() {
                if (t._allowZoom()) {
                  if (clearTimeout(r), t.content.css("visibility", "hidden"),
                    ...
                    return void c();
                  o = s(e), o.css(t._getOffset()), t.wrap.append(o),
                ...
                if (t._allowZoom()) {
                  ...
                  o.css(t._getOffset(!0)), t.wrap.append(o),
                      t.content.css("visibility", "hidden"),
                      setTimeout(function() { o.css(t._getOffset()) }, 16)
                }
              }), T(l + i, function() {
          ...
          _getItemToZoom :
              function() { return t.currItem.hasSize ? t.currItem.img : !1 },
          _getOffset : function(n) {
            var i;
            i = n ? t.currItem.img
                  : t.st.zoom.opener(t.currItem.el || t.currItem);
            var r = i.offset(), o = parseInt(i.css("padding-top"), 10),
            ...
            return $() ? s["-moz-transform"] = s.transform =
      ...
      e.magnificPopup.registerModule(z, {
        ...
        proto : {
          ...
          getIframe : function(n, i) {
              ...
              return r.indexOf(this.index) > -1
                         ? (this.id &&
                                (r = "string" == typeof this.id
                                         ? r.substr(r.lastIndexOf(this.id) +
                                                        this.id.length,
                                                    r.length)
                                         : this.id.call(this, r)),
            ...
            var a = {};
            return o.srcAction && (a[o.srcAction] = r), t._parseMarkup(i, a, n),
        ...
        proto : {
          initGallery : function() {
            ...
            return t.direction = !0,
                   n && n.enabled ? (a += " mfp-gallery", T(p + i, function() {
                                       n.navigateByImgClick &&
                                           t.wrap.on("click" + i, ".mfp-img",
                                                     function() {
                                       ...
                                       n.text &&
                                           (n.text = Y(n.text, t.currItem.index,
                                                       t.items.length))
                                     }), T(f + i, function(e, i, r, o) {
                                       var a = t.items.length;
                                       r.counter =
                                           a > 1 ? Y(n.tCounter, o.index, a)
                                                 : ""
                                     }), T("BuildControls" + i, function() {
          ...
          _preloadItem : function(n) {
            if (n = X(n), !t.items[n].preloaded) {
              var i = t.items[n];
              i.parsed || (i = t.parseEl(n)), E("LazyLoad", i),
                  "image" === i.type &&
                      (i.img = e('<img class="mfp-img" />')
                                   .on("load.mfploader",
                                       function() { i.hasSize = !0 })
                                   .on("error.mfploader",
                                       function() {
                                         i.hasSize = !0, i.loadError = !0,
                                         E("LazyLoadError", i)
                                       })
                                   .attr("src", i.src)),
                  i.preloaded = !0
      ...
      e.magnificPopup.registerModule(U, {
        options : {
          replaceSrc : function(e) {
            return e.src.replace(/\.\w+$/, function(e) { return "@2x" + e })
          },
          ratio : 1
        },
        proto : {
          ...
          function() {
            var t = 1e3, n = "ontouchstart" in window,
                i = function() { C.off("touchmove" + o + " touchend" + o) },
                r = "mfpFastClick", o = "." + r;
              ...
              return e(this).each(function() {
                ...
                if (n) {
                  ...
                  s.on("touchstart" + o, function(e) {
                    d = !1, p = 1,
                    f = e.originalEvent ? e.originalEvent.touches[0]
                                        : e.touches[0],
                    u = f.clientX, c = f.clientY,
                    C.on("touchmove" + o, function(e) {
                       f = e.originalEvent ? e.originalEvent.touches
                                           : e.touches,
                       p = f.length, f = f[0],
                      ...
                      i(), d || p > 1 ||
                               (a = !0, e.preventDefault(), clearTimeout(l),
                                l = setTimeout(function() { a = !1 }, t), r())
                    })
                  })
                }
                s.on("click" + o, function() { a || r() })
              })
    ...
    !function(e) {
      "function" == typeof define && define.amd
          ? define([ "jquery" ], e)
          : e("object" == typeof module && module.exports ? require("jquery")
                                                          : jQuery)
    }(function(e) {
      var t = "1.7.2", n = {}, i = {
        exclude : [],
      ...
      e.fn.extend({
        ...
        smoothScroll : function(t, n) {
          ...
          var i = e.extend({}, e.fn.smoothScroll.defaults, t), r = function(t) {
            var n = function(e) { return e.replace(/(:|\.|\/)/g, "\\$1") },
                r = this, o = e(this),
                a = e.extend({}, i, o.data("ssOpts") || {}), s = i.exclude,
                l = a.excludeWithin, u = 0, c = 0, d = !0, f = {},
          ...
          return null !== t.delegateSelector
                     ? this.undelegate(t.delegateSelector, "click.smoothscroll")
                           .delegate(t.delegateSelector, "click.smoothscroll",
                                     r)
                     : this.unbind("click.smoothscroll")
                           .bind("click.smoothscroll", r),
                 this
        }
      }),
          e.smoothScroll =
            ...
            if ("options" === t && "object" == typeof i)
              return e.extend(n, i);
            var r, o, a, s, l, u = 0, c = "offset", d = "scrollTop", f = {},
                               p = {};
            "number" == typeof t
                ? (r = e.extend({link : null}, e.fn.smoothScroll.defaults, n),
                   a = t)
                : (r = e.extend({link : null}, e.fn.smoothScroll.defaults,
                                t || {}, n),
                   r.scrollElement &&
                       (c = "position",
                ...
                a = "number" == typeof t
                        ...
                        : i ||
                              ...
                              0,
                f[d] = a + u + r.offset, s = r.speed,
                "auto" === s &&
                    (l = Math.abs(f[d] - o[d]()), s = l / r.autoCoefficient),
                p = {
                  duration : s,
                  easing : r.easing,
                  complete : function() { r.afterScroll.call(r.link, r) }
                },
                r.step && (p.step = r.step),
                o.length ? o.stop().animate(f, p)
    ...
    !function(e, t) {
      function n() { k = A = E = S = N = L = M }
      function i(e, t) {
        for (var n in t)
          t.hasOwnProperty(n) && (e[n] = t[n])
      }
      function r(e) { return parseFloat(e) || 0 }
      function o() {
      ...
      function c() {
        for (var e = D.length - 1; e >= 0; e--)
          if (D[e].inited) {
            var t = Math.abs(b(D[e].clone) - D[e].docOffsetTop),
                n = Math.abs(D[e].parent.node.offsetHeight -
                             D[e].parent.height);
            if (t >= 2 || n >= 2)
              return !1
          }
      ...
      function m(e, t) {
        ...
        switch (t) {
        case 0:
          n.position = "absolute", n.left = e.offset.left + "px",
          n.right = e.offset.right + "px", n.top = e.offset.top + "px",
          n.bottom = "auto", n.width = "auto", n.marginLeft = 0,
          n.marginRight = 0, n.marginTop = 0;
          break;
        case 1:
          n.position = "fixed", n.left = e.box.left + "px",
          n.right = e.box.right + "px", n.top = e.css.top, n.bottom = "auto",
          n.width = "auto", n.marginLeft = 0, n.marginRight = 0,
          n.marginTop = 0;
          break;
        case 2:
          n.position = "absolute", n.left = e.offset.left + "px",
          n.right = e.offset.right + "px", n.top = "auto", n.bottom = 0,
          n.width = "auto", n.marginLeft = 0, n.marginRight = 0
        }
        e.mode = t
      }
      function g(e) {
        ...
        n.height = e.height + "px", n.width = e.width + "px",
        ...
        n.padding = n.border = n.borderSpacing = 0, n.fontSize = "1em",
        n.position = "static", n.cssFloat = e.computed.cssFloat,
      ...
      function y(e) {
        var t = getComputedStyle(e), n = e.parentNode, i = getComputedStyle(n),
            o = e.style.position;
          ...
          marginRight : e.style.marginRight
            ...
            f = {
              ...
              limit : {
                ...
                end : c.doc.top + n.offsetHeight - d.numeric.borderBottomWidth -
                          e.offsetHeight - s.top - s.marginBottom
              }
            };
        return f
      }
      ...
      function w() {
        I = setInterval(function() { !c() && E() }, 500)
      }
      function C() { clearInterval(I) }
      function T() { H && (document[P] ? C() : w()) }
      function k() {
        H || (o(), p(), t.addEventListener("scroll", a),
              t.addEventListener("wheel", s), t.addEventListener("resize", E),
              t.addEventListener("orientationchange", E),
              e.addEventListener(B, T), w(), H = !0)
      }
      function E() {
        if (H) {
          h();
      ...
      function S() {
        t.removeEventListener("scroll", a), t.removeEventListener("wheel", s),
            t.removeEventListener("resize", E),
            t.removeEventListener("orientationchange", E),
            e.removeEventListener(B, T), C(), H = !1
      }
      function N() { S(), h() }
      function L() {
        for (N(); D.length;)
      ...
      function j(e) {
        for (var t = D.length - 1; t >= 0; t--)
          D[t].node === e && (f(D[t]), D.splice(t, 1))
      }
      var _, I, D = [], H = !1, O = e.documentElement, M = function() {},
                P = "hidden", B = "visibilitychange";
      void 0 !== e.webkitHidden &&
          (P = "webkitHidden", B = "webkitvisibilitychange"),
          t.getComputedStyle || n();
      for (var F = [ "", "-webkit-", "-moz-", "-ms-" ],
               q = document.createElement("div"), $ = F.length - 1;
           $ >= 0; $--) {
        try {
    ...
    window.jQuery && !function(e) {
      e.fn.Stickyfill = function(
          e) { return this.each(function() { Stickyfill.add(this) }), this }
